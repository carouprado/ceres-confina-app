...
const RACI_MATRIX = [
  { atividade: "Lançamento de títulos a pagar e a receber", r: "Analista Financeiro", a: "Controller", c: "Contador", i: "Diretoria" },
  { atividade: "Validação dos lançamentos financeiros", r: "Contador", a: "Controller", c: "Analista Financeiro", i: "-" },
  { atividade: "Lançamento do imobilizado e depreciação", r: "Contador", a: "Controller", c: "-", i: "-" },
  { atividade: "Conferência de contas (ativo, passivo, despesa, resultado)", r: "Contador", a: "Controller", c: "Analista Financeiro / Fiscal", i: "-" },
  { atividade: "Lançamento manual de CPRF", r: "Contador", a: "Controller", c: "Analista Financeiro", i: "-" },
  { atividade: "Entrada de notas fiscais", r: "Analista Fiscal", a: "Controller", c: "Analista Financeiro", i: "Contador" },
  { atividade: "Emissão de notas fiscais de saída", r: "Analista Fiscal", a: "Controller", c: "-", i: "Contador" },
  { atividade: "Controle de estoque", r: "Analista Fiscal", a: "Controller", c: "-", i: "Contador" },
  { atividade: "Apuração de impostos", r: "Analista Fiscal", a: "Controller", c: "Contador", i: "Diretoria" },
  { atividade: "Fechamento mensal (consolidação)", r: "Controller", a: "Diretoria", c: "Contador / Fiscal / Financeiro", i: "-" },
